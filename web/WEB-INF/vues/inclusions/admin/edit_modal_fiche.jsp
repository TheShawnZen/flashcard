<!-- Edit Modal HTML -->
<div id="editFiche" class="modal fade">
            ...
            <form  method="POST" action="#">
                ...
                <div class="modal-body">					
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" value="idMatiere"required>
                    </div>
                    <div class="form-group">
                        <label>id_etudiant</label>
                        <input type="number" class="form-control" value="idEtudiant" required>
                    </div>
                    <div class="form-group">
